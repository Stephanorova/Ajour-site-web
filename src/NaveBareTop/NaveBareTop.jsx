...
const NaveBareTop = () => {
  ...
  return (
   <div className="header">
          <div className='logo'>
            <span className='groupText'><img src="/web/image/Logo.png" alt="" /></span>
          </div>
         <div className='mainBar'>
          <div className={click ? "mobil-nave" : "navLinks"} onClick={()=>setClick(false)}>
            <a onClick={()=>history.push("/web")} className='navLink'>HOME</a>
            ...
            <a className='navLink' onClick={()=>history.push("/e-learning")}>E- LEARN</a>
